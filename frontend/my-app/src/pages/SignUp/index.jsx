...
<div>
  ...
  <input
    ...
    onChange={(e) => {
      setCoverPreview(e.target.files[0]?.name || null);
    }}
    className="block w-full border rounded px-3 py-2"
  />
  {coverPreview && <p className="text-sm text-gray-600 mt-1">Selected: {coverPreview}</p>}
...
<div>
  ...
  <input
    ...
    onChange={(e) => {
      setProfilePreview(e.target.files[0]?.name || null);
    }}
    className="block w-full border rounded px-3 py-2"
  />
  {profilePreview && <p className="text-sm text-gray-600 mt-1">Selected: {profilePreview}</p>}
